...
public static class FileWriteAheadLogBuilderExtensions {
    ...
    /// </remarks>
    public static IWriteAheadLogBuilder AddFileWriteAheadLog(this IWriteAheadLogBuilder builder, string name, Action<FileWriteAheadLogOptions> configure) {
        ArgumentNullException.ThrowIfNull(builder);
        ArgumentNullException.ThrowIfNull(name);
        ArgumentNullException.ThrowIfNull(configure);
        
        builder.Services.AddOptions<FileWriteAheadLogOptions>(name).Configure(configure);
        
        builder.AddWriteAheadLog(name, (provider, key) => {
