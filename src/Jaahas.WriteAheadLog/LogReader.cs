...
public sealed partial class LogReader : IAsyncDisposable {
    ...
    private readonly FileWriteAheadLog _log;
    ...
    /// </summary>
    /// <param name="log">
    ///   The <see cref="FileWriteAheadLog"/> to read entries from.
    /// </param>
    ...
    /// </exception>
    public LogReader(FileWriteAheadLog log, ICheckpointStore? checkpointStore, ILogger<LogReader>? logger = null) {
